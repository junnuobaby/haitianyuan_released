                ...
                success: function (response) {
                    ...
                    for (key in stock_info) {
                        ...
                        if (stock_info[key].length == 0) {
                            ...
                            var base_funds = '<?php echo $user_data['base_cash']; ?>'; //获取基本总资金
                            var float_pl = decimal((parseFloat(base_funds) - asset_all)*100 / asset_all);
                            $(tr_id).children('td:eq(6)').html(format_num(parseFloat(base_funds) - asset_all));   //设置浮动盈亏
