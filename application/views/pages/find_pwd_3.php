...
<!DOCTYPE html>
<html lang="zh-cn">
<?php $this->load->view('./templates/head', array('title' => '找回密码')); ?>
<body class="bg-gray">
<div class="wrapper">
                    ...
                    <?php echo form_open('/findpwd/findpwd_3_submit', 'class="form-horizontal f_pwd_form" id="reset_pwd_form"'); ?>
                        <div class="form-group <?php echo $new_pwd_error ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-sm-5">
                                ...
                                <span class="new_pwd_error text-danger"></span>
                            </div>
                        </div>
                        <div class="form-group <?php echo $new_pwd_again_error ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-sm-5">
                                ...
                                <span class="new_pwd_again_error text-danger"></span>
                            </div>
                        </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#reset_pwd_btn').click(function () {
            ...
            console.log('pwd_again_value:' + pwd_again_value );
