...
<!DOCTYPE html>
<html lang="zh-cn">
<?php $this->load->view('./templates/head', array('title' => '理财师入驻')); ?>
<?php
$state = $auth_state;
                ...
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body">
                        <div>
                            ...
                            <h5>立即前往我的<strong><a href="<?php echo base_url('index.php/my_center/index'); ?>" class="theme-color">个人中心</a></strong></h5>
                            <ul class="ht_indent">
