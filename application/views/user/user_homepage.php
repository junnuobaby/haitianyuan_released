                        ...
                        <?php foreach ($qa_list as $qa_item): ?>
                            <div class="q_a">
                                <article>
                                    ...
                                    <div class="qu_time">
                                        <span><?php echo $qa_item['qu_timestamp'] ?></span>向<a href="<?php echo base_url('index.php/home/load_home/web/' . 'master' . '/' . $qa_item['master_id'] . '/' . '1'); ?>" class="questioner"><?php echo $qa_item['answerer'];?>提问</a>
