                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <form  class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="email" class="form-control" name="advantage" id="advantage" placeholder="擅长领域">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="email" class="form-control" name="company" id="company" placeholder="所在公司">
                                </div>
                                <span class="text-danger">必填</span>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="real_name" id="real_name" placeholder="请填写身份证上的真实姓名">
                                </div>
                                <span class="text-danger">必填</span>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="user_idc" id="user_idc" placeholder="请输入身份证号码">
                                </div>
                                <span class="text-danger">必填</span>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="file" name="user_idc_pic" id="user_idc_pic" onchange="readFile(this)">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <a href="<?php echo base_url('/index.php/general/settle/3'); ?>" class="btn  btn-block bg-theme">提交</a>
                                </div>
                            </div>
                        </form>
                    </div>
